...
| Object C | Magic123 | Local CUDA GPU | 500 local-formal coarse + 500 local-formal fine iterations (`5000 + 5000` official reference) | Pending | SD + Zero123 coarse NeRF and fine DMTet; local budget adapted after measured 75.18 s guided steps |
